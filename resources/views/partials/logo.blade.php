<script type="module">
    ...
    var BProgress = class {
        ...
        static render(fromStart = false) {
            const parent = typeof this.settings.parent === "string" ? document.querySelector(this.settings
            ...
            progressElements.forEach((progress) => {
                ...
                if (!this.settings.indeterminate) {
                    ...
                    const perc = fromStart ? toBarPerc(0, this.settings.direction) : toBarPerc(this
                        .status || 0, this.settings.direction);
                    toCss(
                        bar,
                        this.barPositionCSS({
                            n: this.status || 0,
        ...
        static remove(progressElement) {
            if (progressElement) {
                ...
                const parent = typeof this.settings.parent === "string" ? document.querySelectorAll(this
                    .settings.parent) : [this.settings.parent];
                parent.forEach((p) => {
        ...
        static getPositioningCSS() {
            ...
            const vendorPrefix = "WebkitTransform" in bodyStyle ? "Webkit" : "MozTransform" in bodyStyle ?
                "Moz" : "msTransform" in bodyStyle ? "ms" : "OTransform" in bodyStyle ? "O" : "";
...
`;
    ...
    function parsePath(path) {
        ...
        const hasQuery = queryIndex > -1 && (hashIndex < 0 || queryIndex < script hashIndex);
